...
{
  return "a8f64cccc781eac9892433e956bab7104ebf1213";
}

const char* MantidVersion::releaseDate()
{
  return "Mon, 24 Feb 2025";
}
...
std::string MantidVersion::doi()
{
  ...
  const unsigned int patchVersion = static_cast<unsigned int>(0);
